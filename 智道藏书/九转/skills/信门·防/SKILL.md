...
- [AI/LLM Attack Surface](../ai-llm-attack-surface/SKILL.md): MCP端点枚举、Function Calling API、LLM推理API认证缺失 (2026)
- [API Recon and Docs](../api-recon-and-docs/SKILL.md): MCP端点发现、gRPC反射、GraphQL over WebSocket/SSE、AI Agent工具调用端点 (2026)
- [Supply Chain Attacks](../supply-chain-attacks/SKILL.md): MCP/AI工具供应链攻击、API依赖投毒 (2026)
- [Telegram Mini App & Bot Security](../telegram-mini-app-bot-security/SKILL.md): TMA后端API授权缺陷、initData验证绕过、Bot Webhook伪造(CVE-2026-25474)、TON API集成安全 (2026)
