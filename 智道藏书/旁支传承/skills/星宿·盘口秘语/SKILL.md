---
name: 星宿·盘口秘语
description: Use when gambling APIs have signatures or encrypted WS.
version: 1.0.0
license: MIT
metadata:
...
## 8. Files
- `scripts/signed_api_client.py` — working Python signed+decrypt client template (fill SECRET/KA/BASE/TOKEN).
...
- `references/xihu-gofun8-session.md`（⚠️本包未含此案例文件，跳过） — session detail: keys, endpoints, desk IDs, findings for xihu02.vip (66U/Lucky) and GoFun8.
