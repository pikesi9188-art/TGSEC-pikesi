...
| FOFA | 网络空间搜索引擎 | `scripts/fofa-search.py '<FOFA语法>'` (必读: `references/fofa-batch-scanning.md` 分页方法论 + 专项语法见 `references/tg-faka-fofa-patterns.md`) |
...
- `scripts/fofa-search.py` — **FOFA API 搜索脚本**（单 key 认证，格式化输出，支持分页/字段筛选）
