...
name: 型乱型
description: >-
  大爱仙尊·PHP type juggling and weak comparison (`==`) bypass. Use when authentication, HMAC/
  signature checks, or token validation uses loose equality, numeric coercion, or hash com
  parisons without strict types — common in legacy PHP and CTF-style code paths.
---
...
- 作业：`传承/乱型.md`
- 工具：`python3 炼蛊房/param_abuse_probe.py juggl --help`
- 长文：`智道藏书/旁支传承/skills/type-juggling/SKILL.md`
- 路由：`python3 炼蛊房/shizhan_pack_route.py --name type-juggling`
