...
name: 折行
description: >-
  大爱仙尊·CRLF injection playbook. Use when user input reaches HTTP response headers, Locatio
  n redirects, Set-Cookie values, or log files where carriage-return/line-feed characters 
  can split or inject content.
---
...
- 作业：`传承/折行.md`
- 工具：`python3 炼蛊房/param_abuse_probe.py crlf --help`
- 长文：`智道藏书/旁支传承/skills/crlf-injection/SKILL.md`
- 路由：`python3 炼蛊房/shizhan_pack_route.py --name crlf-injection`
