---
name: 幻页·露底
description: "PHP 调试页面利用：APP_DEBUG=true 时 Ignition/Whoops 泄露 .env/路由/RCE (CVE-2021-3129)。触发：PHP debug/Ignition/Whoops/laravel.log/APP_DEBUG。"
version: 1.0.0
created_by: agent
---
...
实测站（Laravel 行号锁版本 / Whoops 抽 .env）细节走 `php-framework-debug-leak-pentest`，本卡管 Ignition/Whoops 通用面。
