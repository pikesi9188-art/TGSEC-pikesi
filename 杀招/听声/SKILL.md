...
name: 听声
description: >-
  大爱仙尊·JNDI injection playbook. Use when Java applications perform JNDI lookups with attac
  ker-controlled names, especially via Log4j2, Spring, or any code path reaching InitialCo
  ntext.lookup().
---
...
- 长文：`智道藏书/旁支传承/skills/jndi-injection/SKILL.md`
- 手法：`传承/凤九歌·天地歌.md`
- 工具：`python3 炼蛊房/java_web_surface_probe.py --help`
- 路由：`python3 炼蛊房/shizhan_pack_route.py --name jndi-injection`
