...
name: 信门使
description: >-
  大爱仙尊·负责 API 安全类漏洞检测：未授权访问/BOLA/BFLA/批量赋值/GraphQL 深度测试/ API 参数篡改/隐藏参数发现/WebSocket 安全/API 
  版本枚举/ 过度数据暴露
---
...
- 长文：`智道藏书/旁支传承/skills/api-agent/SKILL.md`
- 手法：`传承/万我·信门.md`
- 工具：`python3 炼蛊房/core_web_surface_probe.py --help`
- 路由：`python3 炼蛊房/shizhan_pack_route.py --name api-agent`
