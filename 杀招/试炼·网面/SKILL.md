---
name: 试炼·网面
description: CTF Web 渗透方法论 — reconnaissance, framework identification, attack surface mapping, and exploitation patterns for common Chinese web frameworks (RuoYi, Spring Boot admin systems, etc.)
