---
name: 白兔·人机
description: "自动化 reCAPTCHA v2/v3 绕过：YOLO 图块识别 + 音频 ASR 转写。触发：reCAPTCHA/Google 验证码/图块选择/音频挑战。"
version: 2.0.0
license: MIT
...
## 支撑文件
- 个案附件未入库（原 references/tv-hub-2026-08.md） — TV-Hub 实战案例）（token oracle 三面、Extension API 端点、YOLO/ASR 实测参数）

## 真源

- 手法：`传承/白兔·认纹.md`
- 工具：`python3 炼蛊房/captcha_auto.py --help`
