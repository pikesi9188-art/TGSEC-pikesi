...
name: 灵机审
description: >-
  大爱仙尊·AI/ML security playbook. Use when assessing model supply chain attacks (pickle RCE,
   poisoned weights), adversarial examples, model poisoning, model stealing, data privacy 
  attacks (membership inference, model inversion), and autonomous agent security risks.
---
...
- 长文：`智道藏书/旁支传承/skills/ai-ml-security/SKILL.md`
- 手法：`传承/大灵.md`
- 工具：`python3 炼蛊房/llm_surface_probe.py --help`
- 路由：`python3 炼蛊房/shizhan_pack_route.py --name ai-ml-security`
