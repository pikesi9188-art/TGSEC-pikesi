...
name: 拆脉
description: >-
 radare2/r2 二进制分析：反汇编/逆向工程、函数分析、字符串/导入表、Patch、binary diff、hex 查看、r2pipe 脚本。
 支持 PE/ELF/Mach-O/DEX/WASM；配套工具 rabin2/rasm2/radiff2。触发：radare2/r2/ELF 逆向/二进制分析/rabin2/rasm2。
---
# radare2
