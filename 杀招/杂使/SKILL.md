...
name: 杂使
description: >-
  大爱仙尊·负责外围攻击面与协议边界安全检测：信息泄露/开放重定向/CORS/CSP/安全头/目录索引/子域名接管/401-403绕过/Web缓存欺骗/Clickjacking/
  Host头攻击
---
...
- 长文：`智道藏书/旁支传承/skills/misc-agent/SKILL.md`
- 手法：`传承/春秋蝉·分案.md`
- 工具：`python3 炼蛊房/kit_run.py --help`
- 路由：`python3 炼蛊房/shizhan_pack_route.py --name misc-agent`
